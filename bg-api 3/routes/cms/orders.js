...
router.get('/', function(req, res, next) {
    ...
    if (currentUser) {
        ...
        res.render('./cms/orders', { user_name:currentUser.user_name,today:todayS})
    }
    else {
...
router.post('/edit',function (req,res,next) {
    ...
    if (currentUser) {
        if (req.body){
            ...
            var unit = AV.Object.createWithoutData('Order',req.body.ID);
