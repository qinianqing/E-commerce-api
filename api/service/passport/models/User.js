...
let getUniqueId = require('../../../utils/getUniqueId');
...
//         'js_user': {readCapacity: 1, writeCapacity: 1},
//     }, function(err) {
//         if (err) {
...
class User {
    ...
    get fwh_open_id() { return this._fwh_open_id; }
    set fwh_open_id(value) { this._fwh_open_id = value; }
