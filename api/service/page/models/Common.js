...
//         'js_common': {readCapacity: 1, writeCapacity: 1},
//     }, function(err) {
//         if (err) {
...
class Common {
    ...
    getAllCategory(callback) {
        CommonM.query('CATEGORY')
            .loadAll()
            .attributes(['source', 'index','category'])
            .exec((err,data) => {
                callback(err,data);
            })
    }
